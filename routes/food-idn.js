...
router.post('/', function(req, res, next) {
  ...
  intentMap.set('checkStuff', checkStuff);
        ...
        var queryUrl = endpoint + "?query=" + encodeURIComponent(query) + "&format=json";
          ...
          return getData(queryUrl)
            .then(aRes => {
              ...
              agent.add('Resep ' + food + '  tanpa ' + ing_stuff);
              agent.add("Bahan-bahan : \n" +ing);
              agent.add("Cara Membuat : \n" +steps);
              agent.add("link : " +link);
              agent.add(+like + "  orang menyukai ini");
      ...
      function checkStuff (agent) {
        ...
        var queryUrl = endpoint + "?query=" + encodeURIComponent(query) + "&format=json";
          ...
          return getData(queryUrl)
            ...
            //   agent.add("link : " +link);
            //   agent.add(+like + "  orang menyukai ini");
            agent.add('Iya, ' +foodName+ ' menggunakan ' +ing_stuff)
         
          }).catch (error => {
            console.log("Something is wrong  !! ");
            console.log(error);
            agent.add('Tidak, ' +foodName+ ' tidak menggunakan ' +ing_stuff)
        });
      };
